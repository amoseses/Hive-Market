  ...
  return (
    <section className="container py-6 md:py-8">
      <div className="mb-4 flex flex-wrap items-end justify-between gap-3">
        <div>
          <h2 className="font-serif text-2xl font-semibold text-market-nav">Featured products</h2>
          <p className="text-muted-foreground mt-0.5 text-sm">Hand-picked picks from our sellers</p>
        </div>
        <Link href="/products" className="market-link text-sm font-medium">
          Shop all →
        </Link>
      </div>
  ...
  return (
    <section className="container py-6 md:py-8">
      <div className="mb-4 flex flex-wrap items-end justify-between gap-3 border-b border-border/40 pb-3">
        <div>
          <h2 className="font-serif text-xl font-semibold text-market-nav md:text-2xl">{title}</h2>
          <p className="text-muted-foreground mt-0.5 text-sm">{subtitle}</p>
        </div>
        <Link href={href} className="market-link text-sm font-medium">
          See more →
        </Link>
      </div>
