...
export default async function FeedbackPage() {
  ...
  return (
    <PageShell narrow>
      <PageHeader
        title="Feedback"
        description="Questions about an order, a product listing, or partnering with Hive Markets? Send us a note and our team will follow up."
      />
      <Card className="market-panel shadow-lg">
