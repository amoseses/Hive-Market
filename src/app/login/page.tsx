    ...
    <AuthShell>
      <div className="flex flex-col gap-4">
        <div className="mb-2 text-center">
          <Link href="/" className="text-2xl font-bold text-market-nav">
        ...
        <Card className="market-panel rounded-sm shadow-md">
          <CardHeader>
        ...
        <p className="text-muted-foreground text-center text-xs">
          By continuing, you agree to Hive Markets&apos; wholesale terms.
        </p>
      </div>
    </AuthShell>
  );
